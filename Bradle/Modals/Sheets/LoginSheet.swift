...
//                    .padding(.top, 20)
//
//                LoginTextField(entry: $viewModel.username, label: "Username", isSecure: false)
//                    .padding(.bottom)
//                LoginTextField(entry: $viewModel.password, label: "Password", isSecure: true)
//                    .padding(.bottom)
//
//
//                Button {
...
//                        dismiss()
//                    } catch {
//                        print("Login or create account failed - \(error)")
//                    }
//                } label: {
//                    if viewModel.loading {
//                        ProgressView()
//                    } else {
//                        Text(viewModel.useCase.primaryButtonLabel)
//                    }
//                }
